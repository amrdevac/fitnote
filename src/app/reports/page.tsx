                ...
                <section className="min-w-[96%] snap-center rounded-md  shadow-[10px_18px_25px_rgba(79,70,229,0.18)] p-5 ">
                  ...
                  <div className="mb-3 flex flex-wrap gap-2 text-[11px]">
                    <button
                      ...
                      className={`rounded-md border px-2.5 py-1 font-semibold transition ${visibleLines.weight
                    ...
                    <button
                      ...
                      className={`rounded-md border px-2.5 py-1 font-semibold transition ${visibleLines.reps
                    ...
                    <button
                      ...
                      className={`rounded-md border px-2.5 py-1 font-semibold transition ${visibleLines.rest
